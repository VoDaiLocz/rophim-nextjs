  ...
  reviews: [
    {
      id: 1,
      user: "minh_quan",
      text: "Phim này hay quá trời luôn, kỹ xảo đỉnh cao...",
      movie: "The Demoness",
    },
    {
      id: 2,
      user: "an_nhien",
      text: "Cốt truyện cảm động, xem mà khóc hết nước mắt.",
      movie: "Once Again",
    },
    {
      id: 3,
      user: "hoang_yen",
      text: "Diễn xuất của nam chính quá đỉnh, mong chờ phần 2.",
      movie: "Long Live the River",
    },
  ],
};
              ...
              {STATS_DATA.interesting.map((item, idx) => (
                ...
                >
                  ...
                  <div className="flex-1 border-b border-white/5 pb-2">
                    <h4 className="text-sm font-bold text-white group-hover:text-[#ffd875] transition-colors line-clamp-1">
                      {item.title}
                    </h4>
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <span className="text-[10px] text-[#ffd875] font-black">
                        {item.rating} IMDb
                      </span>
                    </div>
                  </div>
            ...
            <div className="space-y-4">
              {STATS_DATA.upcoming.map((item, idx) => (
                ...
                >
                  ...
                  <div className="flex-1 border-b border-white/5 pb-2">
                    <h4 className="text-sm font-bold text-white group-hover:text-[#ff5c5c] transition-colors line-clamp-1">
                      {item.title}
                    </h4>
                    <div className="flex items-center gap-2 mt-0.5">
                      <span className="text-[10px] text-white/40 uppercase font-bold">
            ...
            <div className="space-y-5">
              {STATS_DATA.reviews.map((item) => (
                ...
                >
                  ...
                  <p className="text-xs text-white/80 line-clamp-2 italic leading-relaxed mb-2">
                    &quot;{item.text}&quot;
                  </p>
                  <span className="text-[10px] text-[#ffd875] font-bold uppercase tracking-tight">
                    Về phim: {item.movie}
                  </span>
                </div>
              ))}
